...
public class GameManager : MonoBehaviour
{
    ...
    public float WaktuAwal = 0;
    public float WaktuAkhir;
    public int combo = 1;
...

    {
        ...
        Background.transform.Rotate (0f, 0f, Time.deltaTime * -5f);
    }
    ...
    public void CollectByTap (Vector3 tapPosition, Transform parent)
    {
        ...
        if(UserDataManager.Progress.Gold >= 10000000){
            AchievementController.Instance.UnlockAchievement(AchievementType.Gold, "10000000");
        ...
        // Untuk menampilkan achievement pada saat combo mencapai 25 dan 50
        if(combo == 25 || combo == 50){
            AchievementController.Instance.UnlockAchievement(AchievementType.ComboStreak, combo.ToString());
        }
    } 
